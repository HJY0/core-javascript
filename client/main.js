...
import {clearContents, getInputValue, getNode, getRandom, insertLast, isNumbericString, showAlert, copy, addClass, removeClass} from './lib/index.js'
...
function clickCopyHandler() {
  ...
  }) // copy가 됐다면 showAlert을 실행해줘 라는 약속구문
}
